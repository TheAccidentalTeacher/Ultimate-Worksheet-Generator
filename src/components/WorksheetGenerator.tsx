...
export default function WorksheetGenerator({ customization }: WorksheetGeneratorProps) {
  ...
  // Phase 1 Enhanced Template System Functions
  async function generateEnhancedWorksheet() {
    ...
    try {
      ...
      // Convert to our existing result format for now
      setResult({
  ...
  return (
    <div className="w-full space-y-6 min-w-0 max-w-full">
      {/* Phase 1 Enhanced Template System Toggle */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-blue-900 flex items-center gap-2">
              <Sparkles className="h-5 w-5" />
              Enhanced Template System (Phase 1)
            </h3>
          ...
          <button
            onClick={() => setUseEnhancedSystem(!useEnhancedSystem)}
          ...
          >
            {useEnhancedSystem ? 'Enhanced System' : 'Legacy System'}
          </button>
        </div>
      </div>
      ...
      {useEnhancedSystem ? (
        <div className="space-y-6">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Create Professional Worksheet</h2>
            <p className="text-gray-600 mb-6">Follow our guided 6-step process to generate educational content.</p>
            ...
            <div className="min-h-[300px]">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select 
                        ...
                        onChange={(e) => setGenerationRequest(prev => ({
                          ...prev,
                          basicInfo: { ...prev.basicInfo, gradeLevel: parseInt(e.target.value), subject: prev.basicInfo?.subject || 'Math', estimatedTime: prev.basicInfo?.estimatedTime || 30 }
                        }))}
                      >
                    ...
                    <div>
                      ...
                      <select 
                        ...
                        onChange={(e) => setGenerationRequest(prev => ({
                          ...prev,
                          basicInfo: { ...prev.basicInfo, subject: e.target.value as any, gradeLevel: prev.basicInfo?.gradeLevel || 1, estimatedTime: prev.basicInfo?.estimatedTime || 30 }
                        }))}
                      >
              ...
              {currentStep === 1 && (
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">Topic Selection</h3>
                  <div>
              ...
              {currentStep === 2 && (
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">Faith Integration Level</h3>
                  <div className="space-y-3">
                    {[
                      { level: 0, title: 'Secular Content', desc: 'No faith elements' },
                      { level: 1, title: 'Christian Values', desc: 'General values like kindness, honesty' },
                      { level: 2, title: 'Biblical Themes', desc: 'Stories and themes naturally integrated' },
                      { level: 3, title: 'Doctrinal Content', desc: 'Explicit denominational teaching' }
              ...
              {currentStep >= 3 && (
                <div className="text-center py-8">
                  <p className="text-gray-600 mb-4">More workflow steps coming soon!</p>
                  <button
                    onClick={generateEnhancedWorksheet}
                    disabled={loading || !generationRequest.basicInfo?.gradeLevel}
            ...
            <div className="flex justify-between pt-6 border-t">
              ...
              <button
                ...
                disabled={!generationRequest.basicInfo?.gradeLevel && currentStep === 0}
                className="px-6 py-2 bg-blue-600 text-white rounded-lg disabled:bg-gray-400"
              >
                {currentStep < 5 ? 'Next' : 'Generate'}
              </button>
            </div>
          </div>
        </div>
      ) : (
        // Legacy System UI (existing code)
        <div className="space-y-6">
          {/* Original worksheet generator content goes here */}
          <div className="text-center text-gray-600">
            Legacy worksheet generator (original system)
          </div>
        </div>
      )}
      
      {/* Results Section (shared by both systems) */}
      {result && (
        <div className="bg-white rounded-xl border border-gray-200 p-6">
